...
import { ArrowRight, CheckCircle, CircleNotch, ExclamationTriangle, TrashAlt } from "../../components/FontawesomeIcon";
  ...
  const statusIcon = useMemo(() => {
    switch (tx.status) {
      ...
      case TransactionStatus.ERROR:
        return <ExclamationTriangle color="error" />
