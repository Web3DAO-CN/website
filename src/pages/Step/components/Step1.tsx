...
export default function Step() {
  ...
  const [nativeTokenInput, setNativeTokenInput] = useState<string>('')
  const nativeTokenInputCurrencyAmount = useNativeCurrencyAmountForTypeInput(nativeTokenInput)
  ...
  const handleMaxInput = useCallback(() => {
    ...
    setNativeTokenInput(maxAmountSpendCurrencyAmount ? maxAmountSpendCurrencyAmount.toExact() : '')
  ...
  } = useWrapCallback(wrap ? nativeTokenInputCurrencyAmount?.currency : wrappedNativeCurrency, wrap ? wrappedNativeCurrency : nativeTokenInputCurrencyAmount?.currency, nativeTokenInput)
